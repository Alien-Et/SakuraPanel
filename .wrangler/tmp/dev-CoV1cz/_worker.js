...
// .wrangler/tmp/bundle-mHw2Qt/checked-fetch.js
...
var \u6700\u5927\u5931\u8D25\u6B21\u6570 = 5;
var \u9501\u5B9A\u65F6\u95F4 = 5 * 60 * 1e3;
var \u767D\u5929\u80CC\u666F\u56FE = "https://i.meee.com.tw/el91luR.png";
var \u6697\u9ED1\u80CC\u666F\u56FE = "https://i.meee.com.tw/QPWx8nX.png";
    ...
    try {
      ...
      switch (url.pathname) {
        ...
        case "/get-proxy-status":
          ...
          const \u53CD\u4EE3\u5730\u57402 = env.PROXYIP || "ts.hpc.tw";
          const SOCKS5\u8D26\u53F72 = env.SOCKS5 || "";
          let status = "\u76F4\u8FDE";
          if (\u4EE3\u7406\u542F\u7528) {
            if (\u5F3A\u5236\u4EE3\u7406) {
              status = \u4EE3\u7406\u7C7B\u578B === "reverse" && \u53CD\u4EE3\u5730\u57402 ? "\u5F3A\u5236\u53CD\u4EE3" : "\u5F3A\u5236SOCKS5";
            } else if (\u4EE3\u7406\u7C7B\u578B === "reverse" && \u53CD\u4EE3\u5730\u57402) {
              status = "\u52A8\u6001\u53CD\u4EE3";
...
async function \u667A\u80FD\u8FDE\u63A5(\u5730\u5740, \u7AEF\u53E3, \u5730\u5740\u7C7B\u578B, env) {
  ...
  if (\u662F\u57DF\u540D || \u662FIP) {
    ...
    if (\u5F3A\u5236\u4EE3\u7406) {
      if (\u4EE3\u7406\u7C7B\u578B === "reverse" && \u53CD\u4EE3\u5730\u57402) {
        try {
          const [\u53CD\u4EE3\u4E3B\u673A, \u53CD\u4EE3\u7AEF\u53E3] = \u53CD\u4EE3\u5730\u57402.split(":");
          const \u8FDE\u63A5 = connect({ hostname: \u53CD\u4EE3\u4E3B\u673A, port: \u53CD\u4EE3\u7AEF\u53E3 || \u7AEF\u53E3 });
          await \u8FDE\u63A5.opened;
          console.log(`\u5F3A\u5236\u901A\u8FC7\u53CD\u4EE3\u8FDE\u63A5: ${\u53CD\u4EE3\u5730\u57402}`);
          return \u8FDE\u63A5;
        } catch (\u9519\u8BEF) {
...
// .wrangler/tmp/bundle-mHw2Qt/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-mHw2Qt/middleware-loader.entry.ts
